...
div ul a.close {
	background: url(/onlineshopssm/img/close.png) no-repeat 0 0;
	height: 20px;
	display: block;
	margin: 0 auto;
	width: 20px;
			 ...
			 <form class="contact" action="creatOrder.do" method="post" name="orderForm">
			  <input type="hidden" name="total" value="${totalstr}">
			  		  <div class="text" style="margin-top: 12px;">
							<strong>收货方式:</strong><sup>*</sup><br>
							<select name="shfs" required oninvalid="setCustomValidity('请选择收货方式')" oninput="setCustomValidity('');" >
