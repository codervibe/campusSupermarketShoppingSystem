                            ...
                            <div class="ava_price" style="border-bottom: 0px;">
                                <div class="price" >
                                    ...
                                    <div class="price_old" style="margin-top:10px; text-decoration:none;color:#EC6F54;font-weight: bold;">
                                      <div style="float: left;border:0px solid red;height: 25px;line-height: 25px;margin-right: 10px;">￥${product.tprice}</div>
                                      <div style="border:1px solid #EC6F54;width: 50px;height: 20px;line-height: 20px;text-align: center;background:#EC6F54; color:white;font-size: 8px;float: left;border-radius:3px 3px;">特价</div>
                                    </div>
				            		</c:if>
				</div><!-- .price -->
