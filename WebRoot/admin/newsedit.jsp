		...
		<div class="larry-personal-body clearfix changepwd">
			...
			<input type="hidden" name="id" value="${news.id}"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea name="content" placeholder="新闻内容" required class="layui-textarea" oninvalid="setCustomValidity('请输入新闻内容')" oninput="setCustomValidity('');" >${news.content}</textarea>
					</div>
				</div>
