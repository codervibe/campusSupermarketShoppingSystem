			...
			<a class="layui-btn layui-btn-danger" href="javascript:void(0)" onclick="deleteAll()">批量删除</a>
                ...
                <div class="layui-form news_list" >
					...
					<tbody class="news_content" id="userTbody">
					   <c:forEach items="${list}" var="order" varStatus="status">
						<tr >
							...
							<td>
							    <a class="layui-btn layui-btn-mini" href="show.do?id=${news.id}"><i class="iconfont icon-edit"></i> 编辑</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
                    <td align="center" style="font-weight: bold;font-family:楷体;font-weight: bold; color:blue" colspan="10">
                                                                 共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="searchOrdername.do?index=1&orderno=${orderno}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
                        
                        <c:choose>
                        <c:when test="${index >1}">
                        <a href="searchOrdername.do?index=${index-1}&orderno=${orderno}" style="font-family:楷体;">上一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        <a href="searchOrdername.do?index=${index+1}&orderno=${orderno}" style="font-family:楷体;">下一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        &nbsp;&nbsp;
                        <a href="searchOrdername.do?index=${pages}&orderno=${orderno}" style="font-family:楷体;">末页</a>
                    </td>
                  </tr>
					</tbody>
					</table>
