		...
		<div class="larry-personal-body clearfix changepwd">
			...
			<input type="hidden" name="id" value="${product.id}"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="price" id="price" value="${product.price}"  required oninvalid="setCustomValidity('商品单价不能为空或价格输入有误')" oninput="setCustomValidity('');"  pattern="(0|[1-9][0-9]{0,9})(\.[0-9]{1,2})?" style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="商品单价" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea id="editor_id" name="content" placeholder="请输入商品介绍" style="width:700px; height: 500px;"  class="layui-textarea" oninvalid="setCustomValidity('商品介绍不能为空')" oninput="setCustomValidity('');" >${product.content}</textarea>
					</div>
				</div>
