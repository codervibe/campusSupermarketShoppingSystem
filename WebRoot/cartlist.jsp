                ...
                <article>
                    <table class="cart_product">
                        ...
                        <tr>
                            ...
                            <td class="price">
                              <c:if test="${cart.product.tprice gt 0}">
                              	￥${cart.product.tprice}
                              </c:if>
                            </td>
                        ...
                        <div class="grid_4" style="float: right;">
                            <div class="bottom_block total">
                                ...
                                <c:choose>
                                  ...
                                  <c:otherwise>
                                  <button class="checkout" onclick="location.replace('index.do')">快去选购商品吧 <img src="img/checkout.png" alt="" title=""></button>
                                  </c:otherwise>
                                </c:choose>
                            </div><!-- .total -->
                        </div><!-- .grid_4 -->
