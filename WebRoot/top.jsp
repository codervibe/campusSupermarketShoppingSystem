        ...
        <div class="container_12">
            ...
            <div class="grid_9" style="border:0px solid red;width: 98%">
                <div class="top_header">
                    <div class="welcome">
                         <a href="index.do" style="font-size: 24px;text-decoration:none;">线上超市 方便生活</a>.
                    </div><!-- .welcome -->
                    ...
                    <ul id="cart_nav">
                        <li>
                            ...
                            <ul class="cart_cont">
                                ...
                                <li>
                                    <a href="product_page.html" class="prev_cart"><div class="cart_vert"><img src="<%=path %>/upload/${cart.product.filename}" alt="Product 1" title=""></div></a>
                                    <div class="cont_cart" >
